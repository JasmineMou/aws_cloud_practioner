...
D. memory optimized
- good for memory-intensive task, **ideal for high-performance databases**
...
E. storage optimized
- workloads requiring high performance for locally stored data & **suitable for data warehousing applications**
...
2) **Auto Scaling** 
- cost-effective architecture enabling you to **automatically add or remove Amazon EC2 instances in response to changing application demand**, maintaining a greater sense of application availability.
- two approaches
...
Lambda's a service allowing you to upload your code into a Lambda function, which configures a trigger that the service waits for. 
...
5) AWS Fargate
Fargate a serverless compute engine for containers like ECS or EKS, saving you the burden of provisioning/managing server infrastructure (underlying OS/EC2 instances management). 
